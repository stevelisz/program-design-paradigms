...
/**
 * This concrete class represents Filmmakers. It extends AcDaFi abstract class and has all the
 * properties from AcDaFi class.
 */
public class Filmmaker extends AcDaFi {
   ...
   * @param otherMultimedia inherits from parent class.s
   */
  public Filmmaker(String name, int age, String genre, List<String> awards,
