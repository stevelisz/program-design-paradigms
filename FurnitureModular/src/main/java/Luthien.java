...
/**
 * Luthien class extends Cabinet class and with many fixed properties due to its characteristics.
 */
public class Luthien extends Cabinet {

  private ArrayList<String> halfColors = new ArrayList(Arrays.asList("black", "bone"));
  private ArrayList<String> quarColors = new ArrayList(Arrays.asList("black", "bone"));
  ...
  private final int MAX_HALF_DRAWER_AMOUNT = 1;
  private final int MAX_QUARTER_SHELF_AMOUNT = 1;
  private final int MAX_QUARTER_DRAWER_AMOUNT = 1;
  ...
  public boolean equals(Object o) {
    ...
    Luthien luthien = (Luthien) o;
    return shelfAmount == luthien.shelfAmount &&
        drawerAmount == luthien.drawerAmount &&
        colors.equals(luthien.colors) &&
        mounting == luthien.mounting &&
        feet == luthien.feet &&
        rail == luthien.rail;
  }
